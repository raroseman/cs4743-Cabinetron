...
User Interfaces - Inventory list view: See the InventoryView class. Appears on startup (JFrame heading is 'Cabinetron: Inventory'). NOTE: The InventoryView displays more than the InventoryItem class - it uses the linked Part to display the Part Name and Part Number for improved usability.
